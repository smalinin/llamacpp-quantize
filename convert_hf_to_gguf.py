...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="allow Transformers to execute custom model/tokenizer code from the Hugging Face repository",
    )
    parser.add_argument(
...
def enable_transformers_trust_remote_code() -> None:
    from transformers import AutoConfig, AutoTokenizer

    auto_classes = [AutoConfig, AutoTokenizer]
    try:
        from transformers import AutoProcessor
    except ImportError:
        pass
    else:
        auto_classes.append(AutoProcessor)

    for auto_cls in auto_classes:
        original_from_pretrained = auto_cls.from_pretrained

        def from_pretrained(*args, _original_from_pretrained=original_from_pretrained, **kwargs):
            kwargs["trust_remote_code"] = True
            return _original_from_pretrained(*args, **kwargs)

        auto_cls.from_pretrained = from_pretrained
...
def main() -> None:
    ...
    if args.trust_remote_code:
        enable_transformers_trust_remote_code()
